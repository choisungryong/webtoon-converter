            ...
            <div>
              ...
              <div className="mb-4 space-y-4 rounded-xl bg-white/5 p-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-400">
                    단순한 사물 인식을 넘어 이미지의 '맥락'을 이해하는 AI입니다. 사진 속 인물의
                    미묘한 표정 변화, 조명의 분위기, 배경의 서사적 의미까지 파악하여 단순 변환이
                    아닌 '재창조' 수준의 결과물을 만들어냅니다.
                  </p>
                </div>
                <div>
            ...
            <div>
              ...
              <div className="divide-y divide-white/10">
                ...
                <div className="py-3">
                  ...
                  <p className="text-gray-400">
                    현재 버전에서는 영상의 '시각적 요소'만을 분석하여 정지된 웹툰 컷으로 변환합니다.
                    따라서 소리는 포함되지 않으며, 영상 속 가장 극적인 순간들을 포착하여 스토리가
                    있는 이미지 컷으로 재구성해 드립니다.
                  </p>
                </div>
              </div>
            </div>
