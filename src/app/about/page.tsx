      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-8 rounded-2xl border border-[#CCFF00]/30 bg-gradient-to-br from-[#CCFF00]/20 to-transparent p-8 text-center md:p-12">
          ...
          <p className="mb-6 text-xl text-gray-300">
            일상의 바이브를 <strong className="text-neonYellow">툰으로</strong> 담는다
          </p>
          <p className="mx-auto max-w-2xl leading-relaxed text-gray-400">
            BanaToon은 AI 기술을 활용하여 일반 사진이나 영상을 한국 웹툰 특유의 감성적인 스타일로
            변환해주는 서비스입니다.
          </p>
        </div>
        ...
        <div className="mb-8 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <h3 className="mb-2 text-lg font-bold text-white">⚡ 빠른 AI 변환</h3>
            <p className="text-sm leading-relaxed text-gray-400">
              최신 AI 기술로 단 몇 초 만에 사진을 웹툰 스타일로 변환합니다. 복잡한 설정 없이 사진을
              업로드하면 바로 결과 확인!
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <h3 className="mb-2 text-lg font-bold text-white">🎨 다양한 스타일</h3>
            <p className="text-sm leading-relaxed text-gray-400">
              로맨스, 액션, 일상 등 다양한 웹툰 장르 스타일을 선택할 수 있습니다. 각 장르의 특성을
              살린 개성 있는 결과물!
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-purple-500/30 bg-gradient-to-br from-purple-500/20 to-blue-500/10 p-6">
            ...
            <h3 className="mb-2 text-lg font-bold text-white">✨ 스마트 레이아웃</h3>
            <p className="text-sm leading-relaxed text-gray-400">
              AI가 이미지 구도와 중요도를 분석해{' '}
              <strong className="text-purple-300">패널 레이아웃을 자동 최적화</strong>. 반반 분할,
              전체 컷, 오버레이 등 프로 수준의 연출!
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-yellow-500/30 bg-gradient-to-br from-yellow-500/20 to-orange-500/10 p-6">
            ...
            <h3 className="mb-2 text-lg font-bold text-white">💬 AI 말풍선 추천</h3>
            <p className="text-sm leading-relaxed text-gray-400">
              이미지에 맞는 <strong className="text-yellow-300">대사를 AI가 자동 추천</strong>. 클릭
              한 번으로 말풍선 추가, 일반/속마음/외침 스타일 지원!
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-blue-500/30 bg-gradient-to-br from-blue-500/20 to-indigo-500/10 p-6">
            ...
            <h3 className="mb-2 text-lg font-bold text-white">📤 저장 & 공유</h3>
            <p className="text-sm leading-relaxed text-gray-400">
              변환한 이미지는 갤러리에 자동 저장.{' '}
              <strong className="text-blue-300">인스타 스토리·카카오톡 공유</strong>한 번의 클릭으로
              친구들과 바로 공유하세요!
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <h3 className="mb-2 text-lg font-bold text-white">😊 누구나 쉽게</h3>
            <p className="text-sm leading-relaxed text-gray-400">
              회원가입 없이 바로 사용 가능. 사진 드래그 → 스타일 선택 → 변환! 3단계로 끝!
            </p>
          </div>
        </div>
        ...
        <div className="mb-8 rounded-2xl border border-white/10 bg-white/5 p-6 md:p-8">
          <h3 className="mb-6 text-center text-xl font-bold text-white">이용 방법</h3>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 md:p-8">
          ...
          <p className="mb-4 leading-relaxed text-gray-300">
            ...
            복잡한 그래픽 도구나 전문적인 기술 없이도, AI의 힘을 빌려 일상의 순간들을 예술적인
            작품으로 변환할 수 있습니다.
          </p>
          <p className="leading-relaxed text-gray-400">
            K-웹툰의 독특한 감성을 전 세계와 공유하고, 더 많은 사람들이 창작의 즐거움을 느낄 수
            있기를 바랍니다.
          </p>
        </div>
